...
const Footer = () => {
  return (
    <div className="bg-[#191919] px-10 py-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
      <div>
      ...
      <div>
        ...
        <div className="text-gray-300 text-sm flex flex-col gap-2">
          <p>
            Phone: <span className="text-white font-medium">03013492199</span>
          </p>
          <p>
            Email:{" "}
            <span className="text-white font-medium">
              engineeralirao@gmail.com
            </span>
          </p>
        </div>
      </div>
